        ...
        {slides.map(slide=>(
            <div className={`${slide.bg} w-screen h-full flex flex-col gap-16 xl:flex-row`} key={slide.id}>
                ...
                <div className="h-1/2 xl:w-1/2 xl:h-full flex flex-col items-center justify-center gap-8 2xl:gap-12">
                    <h2 className="prata-regular text-xl lg:text-3xl 2xl:text-5xl ">{slide.description}</h2>
                    <h1 className="prata-regular text-5xl lg:text-5xl 2xl:text-8xl font-semibold text-center">{slide.title}</h1>
                    <Link href={slide.url}>
